...
xtestFile <- read.delim("~/Documents/Coursera/wk4Project/UCI HAR Dataset/test/X_test.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)
ytestFile <- read.delim("~/Documents/Coursera/wk4Project/UCI HAR Dataset/test/y_test.txt", header = FALSE, sep = "\t")
subjectTestFile <- read.delim("~/Documents/Coursera/wk4Project/UCI HAR Dataset/test/subject_test.txt", header = FALSE, sep = "\t")
xtrainFile <- read.delim("~/Documents/Coursera/wk4Project/UCI HAR Dataset/train/X_train.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE)
ytrainFile <- read.delim("~/Documents/Coursera/wk4Project/UCI HAR Dataset/train/y_train.txt", header = FALSE, sep = "\t")
subjectTrainFile <- read.delim("~/Documents/Coursera/wk4Project/UCI HAR Dataset/train/subject_train.txt", header = FALSE, sep = "\t")
